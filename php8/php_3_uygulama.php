...
$kurs1_aciklama1=ucfirst(strtolower($kurs1_aciklama));
$kurs1_aciklama2=ucfirst(strtolower($kurs2_aciklama));
$kurs1_aciklama3=ucfirst(strtolower($kurs3_aciklama));
